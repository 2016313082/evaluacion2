...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="form-login" name="form1" action="<%= AppHelper.baseUrl() %>login" method="POST">
    ...
    <script src="<%= AppHelper.baseUrl() %>js/login_validacion.js" type="text/javascript"></script>
</body>
